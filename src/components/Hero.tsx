  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div 
          className="shape absolute top-1/4 left-1/5 w-64 h-64 rounded-full bg-primary/5 animate-float" 
          data-speed="-2"
        ></div>
        <div 
          className="shape absolute bottom-1/4 right-1/5 w-96 h-96 rounded-full bg-primary/10 animate-float" 
          style={{ animationDelay: '1s' }}
          data-speed="3"
        ></div>
        <div 
          className="shape absolute top-1/3 right-1/4 w-32 h-32 rounded-full bg-blue-400/5 animate-float" 
          style={{ animationDelay: '0.5s' }}
          data-speed="-1"
        ></div>
        <div 
          className="shape absolute bottom-1/3 left-1/3 w-48 h-48 rounded-full bg-blue-500/5 animate-float" 
